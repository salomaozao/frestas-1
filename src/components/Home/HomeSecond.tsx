import { ArticleAbout, ArticleContent, HomeContainerSecond, ImageLateralContent, IntroductSection, LinkContainer, TextsContainer } from "@/styles/pages/Home/homeSecond";
    ...
    <HomeContainerSecond>
      <TextsContainer>
        <IntroductSection>
          ...
          <p>O conhecimento<br></br>através das <br></br>frestas</p>
        </IntroductSection>
        <ArticleContent>
        <Image src={vector2} alt=""/>
          <ArticleAbout>
            <p>O Instituto Frestas tem como seu objetivo<br></br>
            ...
            diversas linguagens e mídias.</p>
            <LinkContainer href={`/sobre`}><strong>Saiba mais</strong><Image src={vector3} alt="Saiba mais"/></LinkContainer>
          </ArticleAbout>
        </ArticleContent>
      </TextsContainer>
