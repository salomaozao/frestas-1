...
import {
	...
	Paragraph,
	LocationImage,
} from "@/styles/pages/cursos";
import Image from "next/image";
import { stripe } from "@/utils/stripe";
import { GetServerSideProps } from "next";
import { useState } from "react";
import Stripe from "stripe";
import LocationPinSVG from "../../assets/course/locationPin.svg";
		...
		<>
			<CoursesPage page="actually">
				...
				<CoursesContainer page="actually">
					<h1>Cursos</h1>
					<CoursesNavigation>
						<ChoiceLink border="purple" color="purple" href={`/cursos`}>
							Inscrições abertas
						</ChoiceLink>
						<ChoiceLink border="purple" color="white" href={`/cursos/passados`}>
							Cursos passados
						</ChoiceLink>
					</CoursesNavigation>
					...
					<CourseContainer>
						<CourseMain onClick={openAndCloseDescription}>
							<CourseMainInfo page="actually">
								...
								<LocationContainer>
									<LocationImage src={LocationPinSVG} alt=""></LocationImage>
									<small>
										Avenida Alameda das Travessas, nº 111, Edifício Bosque do
										Cerrado
									</small>
								</LocationContainer>
							</CourseMainInfo>
